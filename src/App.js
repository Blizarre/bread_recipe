  ...
  return (
    <>
      <Row className="justify-content-center">
        <h1 className="mb-5 mt-5">Calculateur d'ingrédients pour pain</h1>
      </Row>
        ...
        <Col md="8" lg="6" xl="5">
          <Form>
            ...
            <Form.Group className="p-3">
              ...
              <Ingredient update={(v) => { setState({ ratioYeast: v }) }} value={state.ratioYeast} name="Proportion de levure de boulanger" unit="%" />
              <Ingredient update={(v) => { setState({ ratioSurdough: v }) }} value={state.ratioSurdough} name="Proportion de levain" unit="%" />
